			...
			else
			{
				do
				{
					...
					case 7:
						break;
					case 8:
						// Esto es porque deberia hacerlo todo en funciones ListaLibros();
						TPosicion todosLibros;
						TLibro mostrarLibros;
						todosLibros.Ida = idAdmin;
						todosLibros.Pos = 0;
						int nLibros;
						printf("\nVamos a intentar mostrar todos los libros de la biblioteca formateados");
						result = nlibros_1(&idAdmin, clnt);
						nLibros = *result;
						printf("\nEl numero de libros a mostrar es %d\n", nLibros);
						MostrarLibro(&mostrarLibros, 0, TRUE);
						mostrarLibros = *descargar_1(&todosLibros, clnt);
						MostrarLibro(&mostrarLibros, 1, FALSE);
						/*for (int i = 0; i < nLibros; ++i)
						{
							todosLibros.Pos++;
							MostrarLibro(mostrarLibros, i + 1, FALSE);
						}*/
						break;
