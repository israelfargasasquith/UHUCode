...
typedef enum Dificultad Dificultad;
...
extern  int * obtenervalor_1(TFC *, CLIENT *);
extern  int * obtenervalor_1_svc(TFC *, struct svc_req *);
...
#define Ayuda 8
extern  void * ayuda_1(TFC *, CLIENT *);
extern  void * ayuda_1_svc(TFC *, struct svc_req *);
#define GetSudoku 9
...
#define ObtenerValor 4
extern  int * obtenervalor_1();
extern  int * obtenervalor_1_svc();
#define ComprobarValor 5
...
extern  bool_t xdr_Dificultad (XDR *, Dificultad*);
