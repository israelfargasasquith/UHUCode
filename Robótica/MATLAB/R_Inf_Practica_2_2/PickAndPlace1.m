...
MatrizPinzaPickGlobal = MatrizPickGlobal*agarre2
MatrizPinzaPlaceGlobal = MatrizPlaceGlobal*agarre2
...
MatrizPlaceGlobal = MatrizPlaceGlobal*Desplazamiento(10,0,0)
end
%pause
%pintaPieza
