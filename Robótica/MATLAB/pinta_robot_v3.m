...
%el valor x e y es para colocar el robot en el grid, con theta mueve el robot entero
% y alpha el angulo de la cabeza, con distancia vamos a representar un
%punto que este a la distancia de un sensor de ultrasonido, 
